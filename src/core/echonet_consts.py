...
CLASS_EPCS = {
    ...
    (0x02, 0x7C): {
        ...
        0xC5: "Measured cumulative amount of power generation",
        0xC6: "Cumulative power generation reset setting",
        ...
        0xCA: "Power generation operation setting",
        ...
        0xD0: "System interconnection status",
        0xD1: "Power generation request time setting",
        0xD2: "Designated power generation status",
    ...
    (0x02, 0x72): {
        ...
        0xE3: "Bath automatic mode setting",
        0xE4: "Bath reheating operation setting",
        0xE5: "Bath hot water addition function setting",
        0xE6: "Lukewarm water temperature lowering function setting",
        0xE7: "Bath hot water volume setting 1",
        0xE8: "Bath hot water volume setting 2",
        0xE9: "Bathroom priority setting",
        0xEA: "Shower hot water supply status",
        0xEB: "Kitchen hot water heating status",
    ...
    (0x02, 0x87): {
        ...
        0xB2: "Channel range specification for cumulative amount of electric energy consumption measurement (simplex)",
        0xB3: "Measured cumulative amount of electric energy consumption list (simplex)",
        ...
        0xB9: "Channel range specification for cumulative amount of electric energy consumption measurement (duplex)",
        0xBA: "Measured cumulative amount of electric energy consumption list (duplex)",
        ...
        0xBE: "Measured instantaneous amount of electric energy list (duplex)",
        0xC0: "Measured cumulative amount of electric energy consumption (normal direction)",
        0xC1: "Measured cumulative amount of electric energy consumption (reverse direction)",
        0xC2: "Unit for cumulative amounts of electric energy consumption",
        0xC3: "Historical data of measured cumulative amount of electric energy consumption 1 (normal direction)",
        0xC4: "Historical data of measured cumulative amount of electric energy consumption 1 (reverse direction)",
        0xC5: "Day for which the historical data of measured cumulative amount of electric energy consumption is to be retrieved 1",
        0xC6: "Measured instantaneous electric power consumption",
        0xC7: "Measured instantaneous currents",
        0xC8: "Measured instantaneous voltage",
